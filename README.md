...
- Machine Learning projects:
  ...
  - [Creating customer segments using different clustering algorithms](https://github.com/LauraCollard/customer_clusters): unsupervised learning project in which we create clusters of customers of a wholesale distributor using different clustering algorithms, including K-means and DBSCAN.
